                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-blue-100">
                          <span className="flex items-center gap-1">
                            ...
                            {event.event_code?.toUpperCase() || 'No Code'}
                          </span>
                          {event.location && (
                            <span className="flex items-center gap-1">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-center gap-2">
                        <Input
                          value={`${window.location.origin}${createPageUrl(`join?code=${event.event_code?.toUpperCase() || ''}`)}`}
                          readOnly
                          className="bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
                        />
                        <Button
                          onClick={() => {
                            navigator.clipboard.writeText(`${window.location.origin}${createPageUrl(`join?code=${event.event_code?.toUpperCase() || ''}`)}`);
                    ...
                    <div>
                      ...
                      <QRCodeGenerator
                        url={`${window.location.origin}${createPageUrl(`join?code=${event.event_code?.toUpperCase() || ''}`)}`}
