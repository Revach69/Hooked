...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {/* Header - only for Home and Join pages */}
      {(currentPageName === "Home" || currentPageName === "join") && (
        <header className="glass-effect border-b border-white/20 dark:border-gray-700 sticky top-0 z-40 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm">
