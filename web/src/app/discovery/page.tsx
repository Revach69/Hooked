...
export default function DiscoveryPage() {
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
          <div className="px-4 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-xl font-bold text-gray-800 dark:text-white">Profile Hidden</h1>
                <p className="text-gray-600 dark:text-gray-300">You are currently hidden from other users</p>
              </div>
              <button
        ...
        <div className="flex-1 flex items-center justify-center px-4 bg-gray-50 dark:bg-gray-900">
          <div className="text-center max-w-md">
            ...
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Your Profile is Hidden</h2>
        ...
        <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
          <div className="flex justify-around py-3">
            <button
              ...
              className="flex flex-col items-center text-pink-500 dark:text-pink-400"
            >
              <User size={24} />
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">{filteredProfiles.length} people discovered</p>
            </div>
      ...
      {/* Bottom Navigation */}
      <div className="bg-white dark:bg-gray-800 border-t fixed bottom-0 left-0 right-0">
        <div className="flex justify-around py-3">
          <button
            onClick={() => router.push('/profile')}
            className="flex flex-col items-center text-gray-400"
