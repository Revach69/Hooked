...
export const metadata: Metadata = {
  title: "Hooked - Meet singles IRL",
  description: "Scan a QR code at the event, see who's single, match, and everything disappears after the event.",
  icons: {
    icon: '/favicon.ico',
    apple: '/icon.png',
  },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-4">
                <a href="https://instagram.com/joinhooked" target="_blank" rel="noopener noreferrer" className="dark-mode-text hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                ...
                <a href="https://www.linkedin.com/company/the-hooked-app/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="dark-mode-text hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
