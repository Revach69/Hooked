...
## 0) Event Time Fields Enhancement
...
**Implementation Priority**: This enhancement should be implemented **first** before conversion wizard and merge features, as subsequent sections assume `end_date` exists.
